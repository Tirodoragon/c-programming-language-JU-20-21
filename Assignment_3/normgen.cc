...
int main() {
    ...
    cout << "Podaj srednia, jakiej chcesz uzyc do wygenerowania danych (losowe liczby wg. rozkladu normalnego: " << endl;
    cin >> avg;
    cout << "Podaj odchylenie standardowe, jak wyzej: " << endl;
    cin >> std_dev;
    ofstream plik;
    plik.open("rnd.txt");
    for(int i = 1; i <= 10000; i++)
    plik << RandNormal(avg, std_dev) << "\n";
    plik.close();
    return 0;
}